...
<body>
    ...
    <div style="width: 900px;" class="container max-w-full mx-auto pt-4">
        <h1 class="text-2xl font-bold mb-4">Creates</h1>
        ...
        <form action="/profile" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea name="content"
                    class="h-24 bg-white border border-gray-300 rounded py-4 px-3 w-full text-gray-600 text-sm focus:outline-none focus:border-gray-400 focus:ring-0"></textarea>
            </div>
