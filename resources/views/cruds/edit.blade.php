...
<body>
    ...
    <div style="width: 900px;" class="container max-w-full mx-auto pt-4">
        ...
        <a href="/crud"
            class="bg-blue-500 tracking-wide text-white px-6 py-2 inline-block mb-6 shadow-lg rounded hover:shadow">back</a>
        ...
        <form action="/crud/{{ $crud->id }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text"
                    ...
                    id="title" name="title" value="{{ $crud->title }}">
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea type="text"
                    ...
                    id="content" name="content">{{ $crud->content }}</textarea>
            </div>
